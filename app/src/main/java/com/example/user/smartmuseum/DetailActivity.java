...
import static com.example.user.smartmuseum.GalleryActivity.EXTRA_CONTENT;
import static com.example.user.smartmuseum.GalleryActivity.EXTRA_CREATOR;
import static com.example.user.smartmuseum.GalleryActivity.EXTRA_LIKES;
import static com.example.user.smartmuseum.GalleryActivity.EXTRA_MEDIA;
import static com.example.user.smartmuseum.GalleryActivity.EXTRA_URL;
import static com.example.user.smartmuseum.R.id.collapseActionView;
import static com.example.user.smartmuseum.R.id.flexible_example_collapsing;
import static com.example.user.smartmuseum.R.id.fullscreen_img;
...
public class DetailActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener, MediaPlayer.OnPreparedListener {
    ...
    public static void start(Context c) {
        c.startActivity(new Intent(c, FlexibleToolbarCollapsing.class));
    }
