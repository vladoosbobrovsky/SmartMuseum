...
public class GalleryActivity extends AppCompatActivity implements ExampleAdapter.OnItemClickListener {
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            mExampleAdapter = new ExampleAdapter(GalleryActivity.this, mExampleList);
                            mRecyclerView.setAdapter(mExampleAdapter);
                            mExampleAdapter.setOnItemClickListener(GalleryActivity.this);
